    ...
    <Modal visible={visible} setVisible={setVisible}>
      <div className="text-sm font-bold">
        ...
        <p className="text-white">
          The Monsta DEX is a fully decentralised digital asset exchange. No
          representation or warranty is made concerning any aspect of the
          Monsta DEX, including its suitability, quality, availability,
          ...
          Monsta DEX is entirely at your own risk and could lead to substantial
          losses. You take full responsibility for your use of the Monsta DEX,
        ...
        <p className="mt-4 text-white">
          The Monsta DEX is not available to residents of Belarus, the Central
          ...
          Monsta DEX is prohibited (“Prohibited Jurisdictions”). In using the
          Monsta DEX, you confirm that you are not located in, incorporated or
